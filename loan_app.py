...
def main():
   ...
   # Gender = st.text_input('Gender',2)
    ...
    Education = st.text_input('Education',1)
    Self_Employed = st.text_input('Self_Employed',0)
    ApplicantIncome = st.number_input('ApplicantIncome',0.070489)
    CoapplicantIncome = st.number_input('CoapplicantIncome',0)
    LoanAmount = st.number_input('LoanAmount',0.201158)
    Loan_Amount_Term = st.number_input('Loan_Amount_Term',360.0)
    Credit_History = st.text_input('Credit_History',1)
    Property_Area = st.text_input('Property_Area',3)
    c = LoanAmount
